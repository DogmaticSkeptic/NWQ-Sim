...
int main(int argc, char* argv[]) {
    ...
    if (pg_world.rank() == 0) {
        ...
        tamm::TiledIndexSpace l_tis{tamm::IndexSpace{tamm::range(1)}};
        tamm::TiledIndexSpace r_tis{tamm::IndexSpace{tamm::range(1)}};
        tamm::TiledIndexSpace p_tis{tamm::IndexSpace{tamm::range(2)}};
